		...
		<table id="wreath" style="border-style:solid; border-left-width:15px; border-color:#c8dba6; margin-top: 5px; width: 730px;">
			...
			<tr>
				<td style="font: normal 16px/18px 'Arial'; color: #89a583;">
					<input type="text" name="wreath_name" id="wreath_name" placeholder="Típus + sorszám" onChange="checkWreathName()">
					<div id="wreath_name_error" for="wreath_name" style="color: #ff0000; margin: 5px 0 0 0;"></div>
