...
<div class="title">
	<span class="firstWord">Rögzített Ajánlatok</span> - Egy hónapnál nem régebbi ajánlatok
</div>
<?php
	...
	$query = "SELECT * 
			FROM offer_wreath
			WHERE archive = 0 AND is_order =0 AND ( DATEDIFF( up_time, CURDATE() ) > -31 OR up_time >= CURDATE() )
