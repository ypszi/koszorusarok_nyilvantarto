...
;(function($) {
    ...
    $.Zebra_DatePicker = function(element, options) {
        ...
        var defaults = {
            ...
            lang_clear_date: 'Adat törlés',

            //  months names
            months: ['Január', 'Február', 'Március', 'Április', 'Május', 'Június', 'Július', 'Agusztus', 'Szeptember', 'Október', 'Novenber', 'December'],
                ...
                if (regexp.length) {
                    ...
                    if ((segments = regexp.exec(str_date))) {
                        ...
                        var tmpdate = new Date(),
							...
							english_months = ['Január', 'Február', 'Március', 'Április', 'Május', 'Június', 'Július', 'Agusztus', 'Szeptember', 'Október', 'Novenber', 'December'],
                            iterable,
